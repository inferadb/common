...
//! [`Transaction`](inferadb_storage::Transaction) trait for atomic
...
use inferadb_storage::{StorageError, StorageResult, Transaction};
...
///
/// ```no_run
/// use inferadb_storage::{StorageBackend, Transaction};
/// use inferadb_storage_ledger::LedgerBackend;
///
